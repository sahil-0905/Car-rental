  ...
  return (
    ...
    max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <div className='group relative'>
            <label htmlFor="image">
            <img src={image ? URL.createObjectURL(image) : user?.image || "https://www.freepik.com/premium-photo/red-jeep-with-number-2-front_275623883.htm#fromView=search&page=1&position=10&uuid=274fbdce-f289-4588-b6d4-01d3d4b4ba8e&query=+thar+Car+Png"} alt="" className='h-9 md:h-14 w-9 md:w-14 rounded-full
            mx-auto' />
