  ...
  return (
    ...
    >
      ...
      <div
        ...
        <div className='hidden lg:flex item-center text-sm gap-2 border border-boderColor px-3 rounded-full max-w-56'> 
            <input type="text" className="py-1.5 w-full big transparent outline-none placeholder gray-500" placeholder="Search Product"/>
